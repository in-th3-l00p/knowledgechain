    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-xl sm:rounded-lg p-6">
                            ...
                            <thead class="bg-gray-50 dark:bg-gray-700">
                                <tr>
                                    ...
                                    <th scope="col" class="px-6 py-3 text-left text-xs font-medium text-gray-500 dark:text-gray-300 uppercase tracking-wider">
                                        {{ auth()->user()->isCoach() ? 'Student/Coach' : 'Coach' }}
                                    </th>
                ...
                <h3 class="text-lg font-medium text-gray-900 dark:text-gray-100 mt-8 mb-4">Past Sessions</h3>
                                ...
                                @foreach($pastSessions as $session)
                                    <tr>
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                            ...
                                            @if($session->status == 'completed' && !$session->hasReview())
                                                <a href="#" class="ml-2 text-indigo-600 dark:text-indigo-400 hover:text-indigo-900 dark:hover:text-indigo-300">Leave Review</a>
                                            @endif
                                        </td>
                                    </tr>
                                @endforeach
                ...
                @else
                    <p class="text-gray-500 dark:text-gray-400">You don't have any past sessions.</p>
                @endif
            </div>
        </div>
    </div>
