<nav x-data="{ open: false }" class="bg-white dark:bg-gray-800 border-b border-gray-100 dark:border-gray-700">
        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    ...
                    <x-nav-link href="{{ route('professional-information') }}" :active="request()->routeIs('professional-information')">
                        {{ __('Professional Info') }}
                    </x-nav-link>
                    
                    @if(auth()->user()->isCoach())
                        <x-nav-link href="{{ route('coach.availability.index') }}" :active="request()->routeIs('coach.availability.*')">
                            {{ __('My Availability') }}
                        </x-nav-link>
                    @endif
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            <x-responsive-nav-link href="{{ route('professional-information') }}" :active="request()->routeIs('professional-information')">
                {{ __('Professional Info') }}
            </x-responsive-nav-link>
            
            @if(auth()->user()->isCoach())
                <x-responsive-nav-link href="{{ route('coach.availability.index') }}" :active="request()->routeIs('coach.availability.*')">
                    {{ __('My Availability') }}
                </x-responsive-nav-link>
            @endif
